    ...
    return (
        <div key={item.product?.id} className="relative flex gap-4 py-3 border-b border-gray-350">
            <div className="min-w-[90px] max-w-[90px] min-h-[90px] aspect-square border border-gray-350 relative">
                ...
                />
                <Badge className='px-2 top-1 left-1'> <span className="text-xs">{item.quantity}x</span></Badge>
            ...
            <div className="flex-grow min-w-0">
                ...
                <p className="mt-1 text-sm gray-550">                    <span>{configData?.data?.currency}</span> {
