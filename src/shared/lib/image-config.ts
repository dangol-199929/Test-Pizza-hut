...
export const FooterLogo = "/images/footerlogo.svg";
...
export const BreadCrumbImage = "/images/breadcrumb.png";
export const UpArrow = "/images/up-arrow-icon.svg";
export const fourzerofour = "/images/404.svg";
...
export const OrderFailure = "/images/payment-failed.png";
export const LocationIcon = "/images/location.svg";
export const HomemImage = "/images/home-about.webp";
export const HomeBgImage = "/images/bg-image.svg";
...
export const whoWeAre = {
  buyNow: "/images/buy-now.webp",
  flowerPot: "/images/flowerpot.webp",
  outlets: "/images/outlets.webp",
  plantConsultation: "/images/plant-consultation.webp",
  telephone: "/images/telephone.webp",
  testimonialBg: "/images/gardner-testi-bg.webp",
  giftAPlant: "/images/gift-a-plant.webp",
  quoteImg: "/images/gardner-quote-img.svg",
};

export const emptyPages = {
  cart: "/images/cart-empty.svg",
  favourite: "/images/wishlist-empty.svg",
  offer: "/images/offer-empty.svg",
  search: "/images/search-empty.svg",
};

export const checkoutImg = {
  delivery: "/images/deliver.svg",
